...
def read_raw_Jrs(file_path):
    ...
    return df
# Usage example
file_path = 'inputs//Jij_from_Hutsepot//tmp_jrs.dat'
file_path2 = 'inputs//Jij_from_Hutsepot//file.str'
df = read_raw_Jrs(file_path)
alat_blat_clat, rb_matrix, atomic_positions_df = read_structure_file((file_path2))
print(df)